...
plot 0 w l lw 1 lt 3 lc rgb "black" notitle,\
     ...
     infileCHORUSNB u ($1+427):(-1*$2/30) w p pt 6 ps 1.3 lw 2 lc rgb "blue" t "NucUnc",\
     infileCHORUSNB u ($1+427):(-1*$3/25) w p pt 4 ps 1.3 lw 2 lc rgb "violet" t "NucCor",\
     infileCHORUSNB u ($1+427):4 w p pt 2 ps 1.3 lw 2 lc rgb "#006400" t "{/Symbol d}T_i@^N"
...
#set label "E605" at 0,3.2
#set key at 90,-2.2

#plot 0 w l lw 1 lt 3 lc rgb "black" notitle,\
#     infileDYE605 u 1:2 w p pt 6 ps 1.3 lw 2 lc rgb "blue" t "NucUnc",\
#     infileDYE605 u 1:3 w p pt 4 ps 1.3 lw 2 lc rgb "violet" t "NucCor",\
#     infileDYE605 u 1:4 w p pt 2 ps 1.3 lw 2 lc rgb "#006400" t "{/Symbol d}T_i^N"	
