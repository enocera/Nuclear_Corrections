...
set label "O@^{p/Cu,(k)}_i          /{/Symbol=\341}O@^p_i {/Symbol=\361}" font 'Helvetica,28' at 1.2,3.25
set label "DYE605" font 'Helvetica,28' at 109,3.25

set xrange[0:120]
set xtics("" 17.5 0, "" 35.5 0, "" 53.5 0, "" 71.5 0, "" 89.5 0, "" 107.5 0)

set label "50 GeV^2 < M^2 < 286 GeV^2" at 1,1.25 font 'Helvetica,22'
set label "{/Symbol h}=-0.2" at 1,-0.35 font 'Helvetica,22'
set label "{/Symbol h}=-0.1" at 18,-0.35 font 'Helvetica,22'
set label "{/Symbol h}=0.0" at 36,-0.35 font 'Helvetica,22'
set label "{/Symbol h}=0.1" at 54,-0.35 font 'Helvetica,22'
set label "{/Symbol h}=0.2" at 72,-0.35 font 'Helvetica,22'
set label "{/Symbol h}=0.3" at 90,-0.35 font 'Helvetica,22'
set label "{/Symbol h}=0.4" at 108,-0.35 font 'Helvetica,22'
...
set key at 120,3.0 font 'Helvetica,26' spacing 1.7
...
plot infile1 using ($1-0.2):2 w p pt 7 ps 0.9 lc rgb "blue" t "EPPS16",\
     ...
     t "{/Symbol=\341}O^{p/Cu}{/Symbol=\361}/{/Symbol=\341}O^p{/Symbol=\361}",\
