...
set label "O@^{Fe,(k)}_i        /{/Symbol=\341}O@^p_i {/Symbol=\361}" font 'Helvetica,28' at 1,3.25
set label "NUTEV (neutrinos)" font 'Helvetica,28' at 37,3.25
...
set key at 45.5,3.0 font 'Helvetica,26' spacing 1.3
...
plot infile1 using ($1-0.2):602 w p pt 5 ps 0.9 lc rgb "red" t "DSSZ12",\
     ...
     t "{/Symbol=\341}O@^{Fe}_i   {/Symbol=\361} /{/Symbol=\341}O^@p_i {/Symbol=\361}",\
...
set label "(antineutrinos)" font 'Helvetica,28' at 39,3.25
