...
set label "{/Symbol=\326}cov_{ii}/y_i" at 20,1.06 font 'Helvetica,22'
set label "CHORUS ({/Symbol n})" at 15,1.16
set label "CHORUS (~{/Symbol=\156}\342\200\276 )" at 660,1.16
set key at 200,1.00 spacing 0.8

plot infileCHORUSNU1 u 1:($2!=0?$2:1/0) w p pt 4 lw 1.5 lc rgb "red" t "cov=C",\
     infileCHORUSNU1 u 1:($3!=0?$3:1/0) w p pt 12 lw 1.5 lc rgb "#006400" t "cov=S",\
     infileCHORUSNU1 u 1:($4!=0?$4:1/0) w p pt 6 lw 1.5 lc rgb "blue" t "cov=C+S",\
     infileCHORUSNB1 u ($1+651):($2!=0?$2:1/0) w p pt 4 lw 1.5 lc rgb "red" notitle,\
     infileCHORUSNB1 u ($1+651):($3!=0?$3:1/0) w p pt 12 lw 1.5 lc rgb "#006400" notitle,\
     infileCHORUSNB1 u ($1+651):($4!=0?$4:1/0) w p pt 6 lw 1.5 lc rgb "blue" notitle
...
plot infileNTVNUDMN1 u 1:($2!=0?$2:1/0) w p pt 4 lw 1.5 lc rgb "red" notitle,\
     infileNTVNUDMN1 u 1:($3!=0?$3:1/0) w p pt 12 lw 1.5 lc rgb "#006400" notitle,\
     infileNTVNUDMN1 u 1:($4!=0?$4:1/0) w p pt 6 lw 1.5 lc rgb "blue" notitle,\
     infileNTVNBDMN1 u ($1+47):($2!=0?$2:1/0) w p pt 4 lw 1.5 lc rgb "red" notitle,\
     infileNTVNBDMN1 u ($1+47):($3!=0?$3:1/0) w p pt 12 lw 1.5 lc rgb "#006400" notitle,\
     infileNTVNBDMN1 u ($1+47):($4!=0?$4:1/0) w p pt 6 lw 1.5 lc rgb "blue" notitle
...
plot infileDYe6051 u 1:($2!=0?$2:1/0) w p pt 4 lw 1.5 lc rgb "red" notitle,\
     infileDYe6051 u 1:($3!=0?$3:1/0) w p pt 12 lw 1.5 lc rgb "#006400" notitle,\
     infileDYe6051 u 1:($4!=0?$4:1/0) w p pt 6 lw 1.5 lc rgb "blue" notitle
